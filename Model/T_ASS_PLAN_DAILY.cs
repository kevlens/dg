...
namespace Model
{
    public class T_ASS_PLAN_DAILY
    {
        ...
        /// <summary>
        /// Desc:计划状态（1：待报；2：审核；3：下发；4：结束；0:：默认值） 
        /// Default:- 
        /// Nullable:True 
        /// </summary>
